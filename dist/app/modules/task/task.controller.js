...
const getAll = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield task_service_1.TaskService.getAll(email, filters, options);
    (0, sendResponse_1.default)(res, {
...
const getById = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _c;
    const result = yield task_service_1.TaskService.getById(req.params.id, (_c = req.user) === null || _c === void 0 ? void 0 : _c.email);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const update = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _d;
    const result = yield task_service_1.TaskService.update(req.params.id, (_d = req.user) === null || _d === void 0 ? void 0 : _d.email, req.body);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const deleteById = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _e;
    const result = yield task_service_1.TaskService.deleteById(req.params.id, (_e = req.user) === null || _e === void 0 ? void 0 : _e.email);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
