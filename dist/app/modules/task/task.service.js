...
const getAll = (email, filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const update = (id, email, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    // update task
    const result = yield task_model_1.Task.findByIdAndUpdate(id, payload, {
      new: true,
    });
    return result;
  });
const deleteById = (id, email) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const task = yield task_model_1.Task.findById(id);
    // check if task exists
    if (!task) {
