...
router.post(
  '/',
  auth_1.default,
  (0, validateRequest_1.default)(task_validation_1.TaskValidation.create),
  task_controller_1.TaskController.create,
);
...
router.patch(
  '/:id',
  auth_1.default,
  (0, validateRequest_1.default)(task_validation_1.TaskValidation.update),
  task_controller_1.TaskController.update,
);
router.delete(
  '/:id',
  auth_1.default,
  task_controller_1.TaskController.deleteById,
);
