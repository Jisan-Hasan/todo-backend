...
const signin = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "User doesn't exists with this email");
    }
    ...
    const accessToken = jwtHelpers_1.jwtHelpers.createToken({ email: user.email }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    // generate refresh token
    const refreshToken = jwtHelpers_1.jwtHelpers.createToken({ email: user.email }, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
